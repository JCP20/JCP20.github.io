...
let currentImage = "";   
window.onload = function () {             //Game config here                         
  game = new Phaser.Game(config);            
  //window.addEventListener("resize", resize, false);         
}
function preload() {
  console.log('Preloading assets...');
  this.load.image('map', 'Images/MapaGeneral.png');  // Replace with your map image path
...
//resize();  // Call the resize function once to set the initial game width
